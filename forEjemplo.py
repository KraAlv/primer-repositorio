...
# ACLAREMOS QUE DATO YA SE CONVERTIRA EN EL VALOR DE LA LISTA NO ES UN INDICE DE RECORRIDO
for dato in lista:
    print(dato)
...
#en el range sobreentiende que iniciará desde 0, por eso solo se le da el parámetro tope
